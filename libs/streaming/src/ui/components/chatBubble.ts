...
export const ChatBubble = c(({ content, name, img, swap }) => {
    return html`<div shadowDom class="flex items-start gap-4 p-4 m-4 w-full bg-gray-50 dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="flex flex-col gap-2 w-full">
            ...
            <div class="p-4 border border-gray-200 bg-white dark:bg-gray-700 rounded-lg">
                <pre class="text-sm text-gray-900 dark:text-gray-300 whitespace-pre-wrap" sse-swap="${swap}" hx-swap="innerHTML">
                    ${content}
                </pre>
                <slot>
