...
import {transformAsyncIterable, type EventMessage} from "@/iterator";
import {YDocStream} from "./ydoc";
import {yMapIterate} from "./map";
import {yArrayIterator} from "./array";

type SSEIterator = AsyncGenerator<EventMessage>;
type ComponentIterator = SSEIterator
 

export class YDocSseHtmx {
