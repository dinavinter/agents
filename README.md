...
The agents are built using a combination of xstate state machines, AI models, and server-side rendering with Server-Sent Events (SSE) to provide a seamless and interactive user experience. Each agent is defined as a state machine that encapsulates the agent's behavior and logic, including state transitions, actions, and side effects.


## Agents Overview

### [Simple Agent](./apps/agnet/agents/simple.ts)
...
### [Parallel Agent](./apps/agnet/agents/parallel.ts)
...
### [Screen Set Builder](./apps/agnet/agents/screen.ts)
...
### [Support Agent](./apps/agnet/agents/screen.ts)
...
### [Tic Tac Toe Agent](./apps/agnet/agents/tictac.ts)
...
### [Test Agent](./apps/agnet/agents/test.ts)
...
### [GitHub Agent](./apps/agnet/agents/git.ts)
...
### [Pinecone Agent](./apps/agnet/agents/pincone.ts)
