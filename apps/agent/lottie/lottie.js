...
export const Animate =c(function({lottie, demo}) {
    const ref =useRef(); 
    
    useEffect(() => {
        if (ref.current) {
            console.log('animating: ',bodymovin.loadAnimation({
                container: ref.current,
                renderer: 'html',
                loop: true,
                autoplay: true,
                animationData: lottie ||demo,
            }))
         }
    }, [ref.current]);
